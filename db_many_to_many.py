...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+mysqlconnector://root:system@localhost/practice"  # URL of DB to establish connection
...
class Customer(db.Model):
    ...
    items = db.relationship("Product", backref="buyers", secondary=customer_product)
